...
import com.example.skinet.error.AppAccessDeniedHandler;
import com.example.skinet.error.AppAuthenticationEntryPoint;
import com.example.skinet.filter.JwtAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .and()
                .addFilterBefore(new JwtAuthorizationFilter(appConfigProperties.getJwt()), UsernamePasswordAuthenticationFilter.class)
                .exceptionHandling()
                .accessDeniedHandler(new AppAccessDeniedHandler())
                .authenticationEntryPoint(new AppAuthenticationEntryPoint());

        http.authorizeRequests()
                .mvcMatchers("/api/account/login/**").permitAll()
